...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
ENABLE_GSL = None
ENABLE_GTK2 = None
ENABLE_LIBXML2 = '-I/home/simone/anaconda2/include/libxml2 -L/home/simone/anaconda2/lib -lxml2 \n'
ENABLE_NSC = False
...
EXAMPLE_DIRECTORIES = ['naming', 'stats', 'bbr-tests', 'tutorial', 'udp-client-server', 'routing', 'realtime', 'socket', 'tcp', 'udp', 'matrix-topology', 'energy', 'error-model', 'wireless', 'traffic-control', 'ipv6']
...
INCLUDES_LIBXML2 = ['/home/simone/anaconda2/include/libxml2']
INCLUDES_PYEMBED = ['/home/simone/anaconda2/include/python2.7']
INCLUDES_PYEXT = ['/home/simone/anaconda2/include/python2.7']
INCLUDES_SQLITE3 = ['/home/simone/anaconda2/include']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_LIBXML2 = ['/home/simone/anaconda2/lib']
LIBPATH_SQLITE3 = ['/home/simone/anaconda2/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_LIBXML2 = ['xml2']
...
NS3_EXECUTABLE_PATH = ['/home/simone/Desktop/AdaptiveBBR/BBRadaptive/build/src/fd-net-device', '/home/simone/Desktop/AdaptiveBBR/BBRadaptive/build/src/tap-bridge']
...
SONAME_ST = '-Wl,-h,%s'
SQLITE_STATS = '-I/home/simone/anaconda2/include -L/home/simone/anaconda2/lib -lsqlite3 \n'
STLIBPATH_ST = '-L%s'
...
cfg_files = ['/home/simone/Desktop/AdaptiveBBR/BBRadaptive/build/ns3/config-store-config.h', '/home/simone/Desktop/AdaptiveBBR/BBRadaptive/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
