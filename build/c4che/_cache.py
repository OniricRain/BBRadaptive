...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-MW0004/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-MW0004/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-MW0004/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv']
CXXFLAGS_PYEXT = ['-fno-strict-aliasing', '-fdebug-prefix-map=/build/python2.7-MW0004/python2.7-2.7.15=.', '-fstack-protector-strong', '-fwrapv', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['bbr-tests', 'energy', 'error-model', 'ipv6', 'matrix-topology', 'naming', 'realtime', 'routing', 'socket', 'stats', 'tcp', 'traffic-control', 'tutorial', 'udp', 'udp-client-server', 'wireless']
...
NS3_EXECUTABLE_PATH = ['/media/luigius/00945B972482D37C/test/ns-allinone-3.27/ns-3.27/build/src/fd-net-device', '/media/luigius/00945B972482D37C/test/ns-allinone-3.27/ns-3.27/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/media/luigius/00945B972482D37C/test/ns-allinone-3.27/ns-3.27/build']
...
VERSION = '3.27'
WITH_PYBINDGEN = '/media/luigius/00945B972482D37C/test/ns-allinone-3.27/pybindgen-0.17.0.post58+ngcf00cc0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/media/luigius/00945B972482D37C/test/ns-allinone-3.27/ns-3.27/build/ns3/config-store-config.h', '/media/luigius/00945B972482D37C/test/ns-allinone-3.27/ns-3.27/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
